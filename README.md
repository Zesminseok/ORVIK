...
[![Version](https://img.shields.io/badge/version-1.3.7-orange.svg)](CHANGELOG.md)
...
- **TCNet output** - native Resolume Arena synchronization over TCNet, with up to 6 layers and bidirectional metadata / metrics (works with other TCNet-compatible software as well)
...
TCNet output (Resolume Arena), PRO DJ LINK input (CDJ-3000 / CDJ-2000NXS2 / DJM-900NXS2), the Web Viewer, and Virtual Deck mode are regularly verified on real hardware.
...
- **macOS Apple Silicon**: `ORVIK-1.3.7-mac-arm64.dmg`
- **macOS Intel**: `ORVIK-1.3.7-mac-x64.dmg`
- **Windows x64**: `ORVIK-1.3.7-win-x64.exe`
...
- **TCNet 출력** - Resolume Arena 네이티브 TCNet 동기화 (최대 6 레이어, 양방향 메타데이터 / 메트릭스 — 다른 TCNet 호환 소프트웨어도 사용 가능)
...
TCNet 출력(Resolume Arena), PRO DJ LINK 입력(CDJ-3000 / CDJ-2000NXS2 / DJM-900NXS2), Web Viewer, Virtual Deck 모드는 실제 하드웨어에서 상시 검증하고 있습니다.
