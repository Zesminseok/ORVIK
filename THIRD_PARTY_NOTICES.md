...
ORVIK is built as an Electron desktop application (Electron 33.x). Electron
...
Bridge 접근은 라이선스 회사 및 인증 제품 맥락에서 설명됩니다. ORVIK는
그 지위를 주장하지 않습니다.
...
ORVIK는 Electron(MIT) 데스크톱 앱이며 Chromium, Node.js, V8, ICU, FFmpeg
